"""Siguiendo el esquema sencillo “pedir datos al usuario”, codifica el subprograma que pida confirmación al usuario (de cualquier cuestión). Valdrá por ejemplo para: 
•	¿eres mayor de edad?, 
