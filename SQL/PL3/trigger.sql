...
BEGIN
  IF TG_OP = 'INSERT' THEN
    INSERT INTO ddbb.auditoria (tabla, accion, usuario, fecha) VALUES (TG_TABLE_NAME, 'alta', SESSION_USER, CURRENT_TIMESTAMP);
  ELSIF TG_OP = 'UPDATE' THEN
    INSERT INTO ddbb.auditoria (tabla, accion, usuario, fecha) VALUES (TG_TABLE_NAME, 'modificación', SESSION_USER, CURRENT_TIMESTAMP);
  ELSIF TG_OP = 'DELETE' THEN
    INSERT INTO ddbb.auditoria (tabla, accion, usuario, fecha) VALUES (TG_TABLE_NAME, 'borrado', SESSION_USER, CURRENT_TIMESTAMP);
  END IF;
  RETURN NULL;
END;
